//! General-purpose array types used across multiple specifications.
//!
//! This module implements the following CDDL productions:
//!
//! | CDDL | Rust |
//! |------|------|
//! | `hash-entry = [hash-alg-id: int, hash-value: bytes]` | [`HashEntry`] / [`HashEntryCbor`] |
//! | `masked-raw-value = [raw-value: bytes, mask: bytes]` | [`MaskedRawValue`] / [`MaskedRawValueCbor`] |
//! | `int-range = [min: int, max: int]` | [`IntRange`] / [`IntRangeCbor`] |
//!
