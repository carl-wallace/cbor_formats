//! Map-based structs from the COSE specification ([RFC 9052]).
//!
//! This module implements the following CDDL productions:
//!
//! | CDDL | Rust |
//! |------|------|
//! | `header_map` / `Generic_Headers` | [`HeaderMap`] / [`HeaderMapCbor`] |
//! | `COSE_Key` | [`CoseKey`] / [`CoseKeyCbor`] |
//! | `COSE_KeySet` | [`CoseKeySet`] |
//!
